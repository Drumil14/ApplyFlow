-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('APPLIED', 'OA', 'INTERVIEW', 'FINAL_ROUND', 'OFFER', 'REJECTED');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('APPLICATION_CREATED', 'APPLICATION_UPDATED', 'STATUS_CHANGED', 'NOTE_ADDED', 'INTERVIEW_SCHEDULED', 'RESUME_UPLOADED', 'ANALYSIS_CREATED');
